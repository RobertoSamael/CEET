...
export default function Nav() {
  return (
    <div className='w-full h-[10vh] justify-center bg-ceet1 bg-opacity-50 fixed sm:flex hidden backdrop-blur-md z-50'>
      
        <div className='w-[200px] h-full flex flex-col items-center cursor-pointer group'>
          <div className='w-full h-full flex justify-center items-center hover:bg-gradient-to-t from-white/10 to-transparent'>
